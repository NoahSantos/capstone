    ...
    <section className='home-events'>
        ...
        <>
          ...
          <div className='text-center max-w-[70rem] m-12'>
            ...
            <button type="button" class="focus:outline-none text-white bg-orange-500 hover:bg-orange-800 focus:ring-2 focus:ring-orange-300 font-medium rounded-lg text-xl px-5 py-2.5 dark:bg-orange-500 dark:hover:bg-orange-700 mt-12"><Link href={{
              pathname: '/event',
              query: { id: item.id },
