...
const Login = () => {
  return (
    ...
    {/* Login Box */}
    <form className="login-container rounded-lg">
      {/* Logo and header */}
      <section className="flex items-center login-header p-4 rounded-t-lg">
        <Image
          ...
          className="size-24 mx-4"
        />
        <p className="text-6xl px-2 text-white">Login</p>
      </section>
      ...
      <section className="px-8 py-6 login-body rounded-b-lg">
        ...
        <div className="flex flex-col w-full items-center">
          ...
          <Link href="/signup" className="text-gray-400 gray-link">Don&#39;t have an account yet? Sign up here!</Link>
